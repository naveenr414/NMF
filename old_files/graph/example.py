...
model = NRNMF(k=2, W=W, alpha=10000, init='random', n_inits=1, max_iter=50000, n_jobs=1)
U, V = model.fit_transform(F)
print(U)

model_lowalpha = NRNMF(k=2, W=W, alpha=100, init='random', n_inits=1, max_iter=500, n_jobs=1)
U_la, V_la = model_lowalpha.fit_transform(F)

model_noreg = NRNMF(k=2, W=W, alpha=0, init='random', n_inits=1, max_iter=500, n_jobs=1)
